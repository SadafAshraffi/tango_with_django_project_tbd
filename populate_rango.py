...
# through each data structure, and add the data to our models.
    ...
    python_pages = [
        {'title': 'Official Python Tutorial',
         'url':'http://docs.python.org/3/tutorial/','views':150},
         {'title':'How to Think like a Computer Scientist',
          'url':'http://www.greenteapress.com/thinkpython/','views':100},
          {'title':'Learn Python in 10 Minutes',
          'url':'http://www.korokithakis.net/tutorials/python/','views':120} ]

    django_pages = [
        {'title': 'Official Django Tutorial',
         'url': 'https://docs.djangoproject.com/en/2.1/intro/tutorial01/','views':16},
        {'title': 'Django Rocks',
            'url': 'http://www.djangorocks.com/','views':17},
        {'title': 'How to Tango with Django',
            'url': 'http://www.tangowithdjango.com/','views':115}]
